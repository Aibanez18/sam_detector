...
class RegionProcessor:
    ...
    def extract_features(self, region: np.ndarray) -> np.ndarray:
        """
        Extract class token/features from a region.
    ...
    def process_all_images(self,
        ...
        for image_filename, image_data in json_data.items():
    ...
    def process_single_image(self, 
        ...
        print(f"Image dimensions: {results['image_dimensions']}")
...
if __name__ == "__main__":
    ...
    image_folder = "flat_images/"
    json_path = "detected_regions.json"
